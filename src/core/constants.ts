export const GAME_EVENTS = {
  ...
  NOTE_COLLECTED: "game:note-collected",
  REGION_ENTERED: "game:region-entered",
  REGION_PROGRESS_RESET: "game:region-progress-reset",
  ALL_PROGRESS_RESET: "game:all-progress-reset",
  TAP: "game:tap",
  POINT: "game:point",
